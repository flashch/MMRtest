...
import com.china.one.commom.mvp.IPresenter;
...
public abstract class BaseActivity<P extends IPresenter> extends RxAppCompatActivity implements IActivity {
     ...
     * 如果返回false,那意味着这个Activity不需要绑定Fragment,那你再在这个Activity中绑定继承于 {@link com.china.one.commom.base.BaseFragment} 的Fragment将不起任何作用
     * @return
     */
    @Override
